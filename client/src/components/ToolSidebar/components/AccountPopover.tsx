...
/**
 * The rail's single account affordance. Clicking the avatar opens a popover
 * in place — never a navigation — per the UX rule "Tools persist. Navigation
 * interrupts." Leaving the workspace (Manage account) is an explicit,
 * labeled action inside the popover.
 */
