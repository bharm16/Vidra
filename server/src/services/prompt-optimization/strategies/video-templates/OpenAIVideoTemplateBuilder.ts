...
4. **Determine Technical Specs**:
   ...
   - **Camera Lens** (camera_lens slot): REQUIRED — always pick a concrete focal length + aperture matched to shot type (Wide=f/8-f/11, Medium=f/2.8-f/4, Close-up=f/1.4-f/2.0). Examples: '28mm at f/11', '85mm at f/1.8', 'anamorphic 50mm at f/2.8'. Null is reserved for cases that explicitly reject all DOF effects (rare). The Few-Shot examples ALWAYS fill this slot — match that pattern.
