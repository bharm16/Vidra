...
Return ONLY JSON (no markdown, no prose):
{
  ...
  "camera_lens": "REQUIRED: focal length plus aperture matched to shot type. Wide Shot → '24mm at f/8' or '28mm at f/11'; Medium Shot → '50mm at f/4' or '35mm at f/2.8'; Close-Up → '85mm at f/1.8' or '85mm prime at f/2.0'; Extreme Close-Up → 'macro 100mm at f/2.8'. Always pick a concrete focal length + f-stop; only use null when the prompt explicitly rejects all lens-based DOF effects (extremely rare).",
  "subject": "Main subject or null",
