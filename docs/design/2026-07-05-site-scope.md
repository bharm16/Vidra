...
Status: **draft for owner sign-off** — companion to the
...
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/`                                                                                | Workspace (renders logged-out too)                                                                                                                            | **Keep — rebuild per M2–M6**                              | The page. Logged-out front door per ADR-0009.                                                                                                                                                                                                         |
...
| `/docs`                                                                            | Finished, but documents the OLD workflow (optimize→refine→preview→generate) and deleted/frozen features (Video Concept Wizard, Model Compilation, Continuity) | **Rewrite to the S0–S6 story (M7)**                       | Until rewritten it actively mis-teaches the product; keep footer-linked only.                                                                                                                                                                         |
...
| `/assets`                                                                          | Asset library CRUD (characters/styles/locations/objects)                                                                                                      | **Park → redirect `/`** (D11)                             | Its consumption surfaces (Characters/Styles panels, reference images) die in M5; server-side assets stay dormant per ADR-0010. Un-park if @-assets ever return.                                                                                       |
...
**M7 — Site coherence (after M4, before launch):** `/home` redirect + wordmark retarget,
rail removal (lands with M5 deletions), Docs rewrite to S0–S6, share-a-clip reshape,
account credit-speak strip, products deletion, 404/redirect audit. Size: **M (3–4 days)**,
almost all copy and routing — plus the one real build, the public clip page.
...
| D10 | `/products`, `/docs`, `/pricing`     | Delete products; rewrite Docs in M7; pricing parked until subscription rewrite.    |
