...
| POST   | `/api/studio/projects/:projectId/images/:imageId/use-in-session` | `server/src/routes/studio.routes.ts`                           |
...
| GET    | `/api/studio/projects/:projectId/unresolved-returns`             | `server/src/routes/studio.routes.ts`                           |
