...
| GET    | `/api/studio/models`                                         | `server/src/routes/studio.routes.ts`                           |
| GET    | `/api/studio/projects`                                       | `server/src/routes/studio.routes.ts`                           |
| POST   | `/api/studio/projects`                                       | `server/src/routes/studio.routes.ts`                           |
| DELETE | `/api/studio/projects/:projectId`                            | `server/src/routes/studio.routes.ts`                           |
| GET    | `/api/studio/projects/:projectId`                            | `server/src/routes/studio.routes.ts`                           |
| PATCH  | `/api/studio/projects/:projectId`                            | `server/src/routes/studio.routes.ts`                           |
| POST   | `/api/studio/projects/:projectId/attachments`                | `server/src/routes/studio.routes.ts`                           |
...
_Generated route count: **104**. Each row reflects a real `router.<method>` call reachable from `app.use` at server boot; conditional registrations (feature-flagged routes) are included because they can be registered under some configuration._
