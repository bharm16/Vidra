...
- **Merge decision (owner's call):** the branch is certified green and fast-forwards onto `main` cleanly. Merge now and feel-pass on main, or feel-pass on the branch first — nothing technical blocks either.
